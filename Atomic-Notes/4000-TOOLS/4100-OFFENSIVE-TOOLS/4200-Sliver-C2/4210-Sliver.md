...
## Generating Beacons
There's a lot of factors. The below generates a beacon that is called 'http_beacon', is a windows executable, skips symbol obfuscation, listens on 127.0.0.1 (default port 80)
```bash
