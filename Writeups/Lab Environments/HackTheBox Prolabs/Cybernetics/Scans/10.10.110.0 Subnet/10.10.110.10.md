...
That doesn't work. It turns out that it's actually the cywebdw MSSQL server that we can authenticate to. This makes sense, because we're on a web server. Also note the doma
```
